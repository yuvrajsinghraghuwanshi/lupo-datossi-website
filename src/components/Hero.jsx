...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-offwhite overflow-hidden">
      ...
      <div className="container-narrow relative z-10 pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          {/* Left Content */}
          <div className="lg:col-span-7 space-y-8">
            {/* Overline */}
            <div className="animate-fade-in-up opacity-0">
              <span className="heading-sub">Vice President &mdash; Mergers &amp; Acquisitions</span>
            </div>
            ...
            <p className="body-large max-w-xl animate-fade-in-up opacity-0 delay-200">
              London-based investment banking professional focused on complex M&amp;A,
              cross-border transactions and strategic financial advisory.
            </p>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-fade-in opacity-0 delay-600">
        ...
        >
          ...
          <svg width="16" height="24" viewBox="0 0 16 24" fill="none" className="animate-bounce" style={{ animationDuration: '2s' }}>
            <path d="M8 4L8 20M8 20L2 14M8 20L14 14" stroke="currentColor" strokeWidth="1" />
          </svg>
        </button>
      </div>
    </section>
